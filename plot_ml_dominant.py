...
rects4 = ax.bar(x + 1.5*width, admm_scores, width, label='ADMM-Lasso', color='#8c564b')

ax.set_ylabel('R² Score (Higher is Better)', fontsize=14, fontweight='bold')
ax.set_title('Hybrid Model vs Classical Machine Learning Architectures', fontsize=18, fontweight='bold', pad=20)
ax.set_xticks(x)
...
fig.tight_layout()
out_path = r"C:\Users\bhara\.gemini\antigravity\brain\1595fb12-0302-4ada-a005-41162795f2e3\artifacts\ml_dominant_chart.png"
